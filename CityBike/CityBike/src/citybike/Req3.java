...
public class Req3 extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        JobConf job = new JobConf(conf, Req3.class);

        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);

        job.setMapperClass(Req3Mapper.class);
        ...
        fs.delete(new Path(inputPath + "/out/3"), true);

        FileOutputFormat.setOutputPath(job, new Path(inputPath + "/out/3"));
